...
@Service
public class PostMappingRenderer extends MethodRenderer {

    private ParameterNameDiscoverer parameterNameDiscoverer;

    public PostMappingRenderer(TemplateReader templateReader, ParameterNameDiscoverer parameterNameDiscoverer) {
    ...
    private boolean validate(Annotation annotation) {
        return annotation instanceof PostMapping || (annotation instanceof RequestMapping && ArrayUtils.contains(((RequestMapping) annotation).value(), RequestMethod.POST));
    }
}
