...
var TableSelector = function (_React$Component) {
    ...
    function TableSelector(props) {
        ...
        _this.state = { servers: [], databases: [], tables: [], serverId: 0, databaseName: '', tableName: '' };
        if (_this.props.table != null) {
            _this.state.serverId = _this.props.table.serverId;
            _this.state.databaseName = _this.props.table.database;
            _this.state.tableName = _this.props.table.table;

            _this.serverSelected(_this.state.serverId);
            _this.databaseSelected(_this.state.databaseName);
        }
        return _this;
    }
    ...
    _createClass(TableSelector, [{
        ...
        value: function serverSelected(serverId) {
            ...
            _mysqlApiClient2.default.getDatabasesForServer(serverId).done(function (data) {
                return _this3.setState({ databases: data, serverId: serverId });
            });
        }
    }, {
        key: "databaseSelected",
        value: function databaseSelected(databaseName) {
            var _this4 = this;

            _mysqlApiClient2.default.getTablesForServerAndDatabase(this.state.serverId, databaseName).done(function (data) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_select2.default, { className: "mt-3 fullWidth",
                ...
                _react2.default.createElement(_select2.default, { className: "mt-3 fullWidth",
                    ...
                    onItemClick: function onItemClick(option) {
                        _this5.setState({ tableName: option.value });
                        if (_this5.props.onSelected !== undefined) {
                            _this5.props.onSelected({
                                serverId: _this5.state.serverId,
                                databaseName: _this5.state.databaseName,
...
},{"../api-client/mysql-api-client":2,"./select":4,"react":29}],6:[function(require,module,exports){
/**
...
},{"./table-structure-sync.js":31,"./task-create.js":32,"./task-detail.js":33}],31:[function(require,module,exports){
"use strict";
...
},{"./common/table-selector":5,"react":29,"react-dom":26}],32:[function(require,module,exports){
'use strict';
...
var TaskCreate = function (_React$Component) {
    ...
    _createClass(TaskCreate, [{
        ...
        key: 'tableSelected',
        value: function tableSelected(o, isSource) {
            var _this2 = this;
            ...
            if (this.state.table.source != null && this.state.table.target != null) {
                ...
                _mysqlApiClient2.default.getFieldForServerDatabaseAndTable(o.serverId, o.databaseName, o.tableName).done(function (data) {
...
},{"./api-client/mysql-api-client":2,"./api-client/task-api-client":3,"./common/table-selector":5,"react":29,"react-dom":26}],33:[function(require,module,exports){
'use strict';
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            { type: 'button', className: 'float-right btn btn-primary btn-sm',
                                onClick: function onClick() {
                                    return _taskApiClient2.default.startFullMigrationTask(taskId).done(function (data) {
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    { type: 'button', className: 'float-right btn btn-primary btn-sm ml-1',
                                        onClick: function onClick() {
                                            $.get(DOMAIN + '/api/task/detail/' + taskId + '/stop-incremental-migration').done(function (data) {
                                                if (!data.success) {
...
},{"./api-client/task-api-client":3,"react":29,"react-dom":26}]},{},[30]);
