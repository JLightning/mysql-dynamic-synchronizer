...
},{"./ws-client":4}],2:[function(require,module,exports){
'use strict';
...
},{"@stomp/stompjs":10}],5:[function(require,module,exports){
'use strict';
...
},{"react":35}],7:[function(require,module,exports){
"use strict";
...
var TableSelectorEditable = function (_TableSelector) {
    ...
    function TableSelectorEditable(props) {
        ...
        return _possibleConstructorReturn(this, (TableSelectorEditable.__proto__ || Object.getPrototypeOf(TableSelectorEditable)).call(this, props));
    }
...
},{"./table-selector":8,"react":35}],8:[function(require,module,exports){
"use strict";
...
},{"../api-client/mysql-api-client":2,"./select":6,"react":35}],9:[function(require,module,exports){
'use strict';
...
},{"react":35}],10:[function(require,module,exports){
...
},{"./lib/stomp.js":11,"websocket":36}],11:[function(require,module,exports){
...
},{"./emptyFunction":16,"_process":27}],26:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"./lib/ReactPropTypesSecret":29,"_process":27}],29:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"_process":27,"fbjs/lib/ExecutionEnvironment":12,"fbjs/lib/camelizeStyleName":14,"fbjs/lib/containsNode":15,"fbjs/lib/emptyFunction":16,"fbjs/lib/emptyObject":17,"fbjs/lib/getActiveElement":18,"fbjs/lib/hyphenateStyleName":20,"fbjs/lib/invariant":21,"fbjs/lib/shallowEqual":24,"fbjs/lib/warning":25,"object-assign":26,"prop-types/checkPropTypes":28,"react":35}],31:[function(require,module,exports){
/** @license React v16.4.1
...
},{"fbjs/lib/ExecutionEnvironment":12,"fbjs/lib/containsNode":15,"fbjs/lib/emptyFunction":16,"fbjs/lib/emptyObject":17,"fbjs/lib/getActiveElement":18,"fbjs/lib/invariant":21,"fbjs/lib/shallowEqual":24,"object-assign":26,"react":35}],32:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":27,"fbjs/lib/emptyFunction":16,"fbjs/lib/emptyObject":17,"fbjs/lib/invariant":21,"fbjs/lib/warning":25,"object-assign":26,"prop-types/checkPropTypes":28}],34:[function(require,module,exports){
/** @license React v16.4.1
...
},{"fbjs/lib/emptyFunction":16,"fbjs/lib/emptyObject":17,"fbjs/lib/invariant":21,"object-assign":26}],35:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":33,"./cjs/react.production.min.js":34,"_process":27}],36:[function(require,module,exports){
...
},{"./table-structure-sync.js":40,"./task-create.js":41,"./task-detail.js":42}],40:[function(require,module,exports){
"use strict";
...
var TableStructureSync = function (_React$Component) {
    ...
    function TableStructureSync(props) {
        ...
        _this.state = { fields: [], table: {}, readyForSubmit: false };
        return _this;
    }
        ...
        value: function tableSelected(params, isSource) {
            ...
            _mysqlApiClient2.default.getFieldForServerDatabaseAndTable(params.serverId, params.database, params.table).done(function (data) {
                ...
                data.forEach(function (field) {
                    return fields.push({ sourceField: field.field, mappable: true, targetField: field.field });
                });
...
},{"./api-client/mysql-api-client":2,"./common/editable-text":5,"./common/table":9,"./common/table-selector":8,"./common/table-selector-editable":7,"react":35,"react-dom":32}],41:[function(require,module,exports){
'use strict';
...
var TaskCreate = function (_React$Component) {
    ...
    function TaskCreate(props) {
        ...
        _this.state = { taskName: '', fields: [], table: {}, readyForSubmit: false, filters: [] };
    ...
    _createClass(TaskCreate, [{
        ...
        value: function getMapping() {
            ...
            _mysqlApiClient2.default.getMappingFor2TableFlat(sourceParam.serverId, sourceParam.database, sourceParam.table, targetParam.serverId, targetParam.database, targetParam.table, mapping).done(function (data) {
                _this3.setState({ fields: data });
                _this3.recalculateReadyForSubmit();
            });
        }
    }, {
        key: 'handleMappableChange',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'name', name: 'name',
                            defaultValue: this.state.taskName, onChange: function onChange(e) {
                                _this4.setState({ taskName: e.target.value });
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_tableSelector2.default, { table: this.state.table.source, title: 'Source',
                                onSelected: function onSelected(o) {
                                    return _this4.tableSelected(o, true);
                                } })
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(_tableSelector2.default, { table: this.state.table.target, title: 'Target',
                                onSelected: function onSelected(o) {
                                    return _this4.tableSelected(o, false);
                                } })
                        )
                    ),
                    _react2.default.createElement(
                    ...
                    this.state.fields.length > 0 ? _react2.default.createElement(
                        ...
                        _react2.default.createElement(FieldRowList, {
                            ...
                            handleMappableChange: function handleMappableChange(e, idx) {
                                return _this4.handleMappableChange(e, idx);
                            },
                    ...
                    _react2.default.createElement(TaskFilter, { filters: this.state.filters, addFilter: function addFilter(filter, cb) {
                            _mysqlApiClient2.default.validateFilter(state.table.source.serverId, state.table.source.database, state.table.source.table, filter).done(function (data) {
                                var filters = _this4.state.filters;
                                filters.push(data);
                                _this4.setState({ filters: filters });
                                cb();
                            });
                        },
...
var TaskFilter = function (_React$Component2) {
    ...
    function TaskFilter(props) {
        ...
        var _this5 = _possibleConstructorReturn(this, (TaskFilter.__proto__ || Object.getPrototypeOf(TaskFilter)).call(this, props));

        _this5.state = { filters: _this5.props.filters || [], inputValue: '' };
        return _this5;
    }
                        ...
                        return _react2.default.createElement(
                            ...
                            { key: idx, className: 'filter btn btn-secondary btn-sm mr-2',
                                onClick: function onClick(idx) {
                                    return _this6.props.removeFilter(idx);
                                } },
                            _react2.default.createElement(
                                'span',
                                null,
                ...
                _react2.default.createElement('input', { type: 'text', className: 'form-control mt-2', id: 'filter', name: 'filter', placeholder: 'Enter Task Name',
                    onKeyPress: function onKeyPress(e) {
                        if (e.key === 'Enter') {
                            ...
                            if (value.trim() !== '') {
                                _this6.props.addFilter(value, function () {
                                    return _this6.setState({ inputValue: '' });
                                });
                            }
                            return;
                        }
                    ...
                    onChange: function onChange(e) {
                        return _this6.setState({ inputValue: e.target.value });
                    } })
            );
        }
    }]);
        ...
        value: function render() {
            ...
            return this.props.fields.map(function (field, idx) {
                return _react2.default.createElement(FieldRow, _extends({
                    ...
                    onDrop: _this8.onDrop.bind(_this8),
                    captureDrapStartField: _this8.captureDrapStartField.bind(_this8)
                }));
            });
        }
    }]);
...
var FieldRow = function (_React$Component4) {
    ...
    function FieldRow(props) {
        ...
        var _this9 = _possibleConstructorReturn(this, (FieldRow.__proto__ || Object.getPrototypeOf(FieldRow)).call(this, props));

        _this9.state = { dropTargetClass: '', custom: false };
        return _this9;
    }
        ...
        value: function getSourceText() {
            ...
            if (this.state.custom) return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'text', value: field.sourceField,
                    onChange: function onChange(e) {
                        return _this10.props.editField(_this10.props.idx, e.target.value);
                    } }),
                _react2.default.createElement('i', { className: 'fa fa-check-square-o ml-2', 'aria-hidden': 'true',
                    onClick: function onClick() {
                        return _this10.setState({ custom: false });
                    } })
            );
            return _react2.default.createElement(
                'div',
                { onClick: function onClick() {
                        return _this10.setState({ custom: true });
                    },
                    style: { minHeight: '1.5rem' } },
                field.sourceField
            );
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { className: this.state.dropTargetClass + ' pointer',
                        ...
                        onDragStart: function onDragStart() {
                            _this11.setState({ dropTargetClass: 'bg-success text-white' });
                            _this11.props.captureDrapStartField(field);
                        },
                        onDrop: function onDrop() {
                            _this11.onDrop();
                            _this11.props.onDrop(field);
                        },
                        onDragOver: function onDragOver(e) {
                            return _this11.onDragOver(e);
                        },
                        onDragLeave: function onDragLeave(e) {
                            return _this11.onDragLeave(e);
                        }
                    },
                    sourceText
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'checkbox', checked: field.mappable,
                        onChange: function onChange(e) {
                            return _this11.props.handleMappableChange(e);
                        } })
                ),
...
},{"./api-client/mysql-api-client":2,"./api-client/task-api-client":3,"./common/table":9,"./common/table-selector":8,"react":35,"react-dom":32}],42:[function(require,module,exports){
'use strict';
...
},{"./api-client/task-api-client":3,"react":35,"react-dom":32}]},{},[39]);
