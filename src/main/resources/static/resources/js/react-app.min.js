            ...
            if (this.state.table.source != null && this.state.table.target != null) {
                ...
                $.ajax('/api/mysql/fields-mapping', {
                    ...
                    if (data.success) {
                        ...
                        _this2.setState({ fields: fields, readyForSubmit: true });
                    }
                });
            } else {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'td',
                    null,
                    _react2.default.createElement('input', { type: 'checkbox', defaultChecked: field.mappable, onChange: function onChange(e) {
