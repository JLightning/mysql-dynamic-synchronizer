...
},{"./select":1,"react":26}],3:[function(require,module,exports){
/**
...
},{"./table-structure-sync.js":28,"./task-create.js":29,"./task-detail.js":30}],28:[function(require,module,exports){
"use strict";
...
},{"./common/table-selector":2,"react":26,"react-dom":23}],29:[function(require,module,exports){
'use strict';
    ...
    _createClass(TaskCreate, [{
        ...
        value: function tableSelected(o, isSource) {
            ...
            if (this.state.table.source != null && this.state.table.target != null) {
                ...
                $.get(DOMAIN + '/api/mysql/fields', params).done(function (data) {
                    if (data.success) {
                        var fields = _this2.state.fields;
                        data.data.forEach(function (field, i) {
                            if (fields.length > i) {
                                fields[i][sub] = field;
                            } else {
                                var _o = {};
...
},{"./common/table-selector":2,"react":26,"react-dom":23}],30:[function(require,module,exports){
'use strict';
