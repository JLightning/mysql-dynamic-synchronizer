...
var TaskCreate = function (_React$Component) {
    ...
    function TaskCreate(props) {
        ...
        _this.state = { taskName: '', fields: [], table: {}, readyForSubmit: false };
        ...
        value: function render() {
            ...
            return this.props.fields.map(function (field, idx) {
                return _react2.default.createElement(FieldRow, {
                    ...
                    idx: idx,
                    field: field,
                    editField: _this6.props.editField,
                    handleMappableChange: function handleMappableChange(e) {
                        return _this6.props.handleMappableChange(e, idx);
                    },
                    onDrop: _this6.onDrop.bind(_this6),
                    captureDrapStartField: _this6.captureDrapStartField.bind(_this6)
                });
            });
        }
    }]);
...
var FieldRow = function (_React$Component3) {
    ...
    function FieldRow(props) {
        ...
        var _this7 = _possibleConstructorReturn(this, (FieldRow.__proto__ || Object.getPrototypeOf(FieldRow)).call(this, props));

        _this7.state = { dropTargetClass: '', custom: false };
        return _this7;
    }
            ...
            if (this.state.custom) return _react2.default.createElement(
                ...
                _react2.default.createElement('input', { type: 'text', value: field.sourceField,
                    onChange: function onChange(e) {
                        return _this8.props.editField(_this8.props.idx, e.target.value);
                    } }),
                _react2.default.createElement('i', { className: 'fa fa-check-square-o ml-2', 'aria-hidden': 'true', onClick: function onClick() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { className: this.state.dropTargetClass + ' pointer',
                        ...
                        onDragStart: function onDragStart() {
                            _this9.setState({ dropTargetClass: 'bg-success text-white' });
                            _this9.props.captureDrapStartField(field);
                        },
                        onDrop: function onDrop() {
                            _this9.onDrop();
                            _this9.props.onDrop(field);
                        },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'checkbox', checked: field.mappable,
                        onChange: function onChange(e) {
                            return _this9.props.handleMappableChange(e);
                        } })
                ),
...
var TableSelector = function (_React$Component4) {
    _inherits(TableSelector, _React$Component4);

    function TableSelector(props) {
        _classCallCheck(this, TableSelector);

        var _this10 = _possibleConstructorReturn(this, (TableSelector.__proto__ || Object.getPrototypeOf(TableSelector)).call(this, props));

        _this10.state = { servers: [], databases: [], tables: [], serverId: 0, databaseName: '', tableName: '' };
        if (_this10.props.table != null) {
            _this10.state.serverId = _this10.props.table.serverId;
            _this10.state.databaseName = _this10.props.table.database;
            _this10.state.tableName = _this10.props.table.table;

            _this10.serverSelected(_this10.state.serverId);
            _this10.databaseSelected(_this10.state.databaseName);
        }
        return _this10;
    }
    ...
    _createClass(TableSelector, [{
        ...
        value: function getServers() {
            ...
            $.get(DOMAIN + '/api/mysql/servers').done(function (data) {
                if (data.success) {
                    _this11.setState({ servers: data.data });
                }
            });
        }
    }, {
        ...
        value: function serverSelected(serverId) {
            ...
            $.get(DOMAIN + '/api/mysql/databases', { serverId: serverId }).done(function (data) {
                if (data.success) {
                    _this12.setState({ databases: data.data, serverId: serverId });
                }
            });
        }
    }, {
        ...
        value: function databaseSelected(databaseName) {
            ...
            $.get(DOMAIN + '/api/mysql/tables', { serverId: this.state.serverId, database: databaseName }).done(function (data) {
                if (data.success) {
                    _this13.setState({ tables: data.data, databaseName: databaseName });
                }
            });
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this14.serverSelected(option.id);
                    } }),
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this14.databaseSelected(option.value);
                    } }),
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        _this14.setState({ tableName: option.value });
                        if (_this14.props.onSelected !== undefined) {
                            _this14.props.onSelected({
                                serverId: _this14.state.serverId,
                                databaseName: _this14.state.databaseName,
