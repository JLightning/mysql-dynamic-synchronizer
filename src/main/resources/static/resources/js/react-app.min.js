...
var Modal = function (_React$Component) {
    ...
    _createClass(Modal, [{
        ...
        key: 'checkChildProps',
        value: function checkChildProps() {
            var contents = [];
            var buttons = [];
            ...
            this.setState({ contents: contents, buttons: buttons });
        }
    }, {
        key: 'show',
        value: function show() {
...
require('./task-create.js');

require('./task-detail.js');

require('./table-structure-sync.js');

},{"./table-structure-sync.js":42,"./task-create.js":43,"./task-detail.js":44}],42:[function(require,module,exports){
"use strict";
...
if (document.getElementById('taskCreateWrapper') !== null) {
    _reactDom2.default.render(_react2.default.createElement(TaskCreate, null), document.getElementById('taskCreateWrapper'));
}

},{"./api-client/mysql-api-client":2,"./api-client/task-api-client":3,"./common/select":8,"./common/table":11,"./common/table-selector":10,"react":37,"react-dom":34}],44:[function(require,module,exports){
'use strict';
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_modal.ModalButton, { title: 'No' }),
                    _react2.default.createElement(_modal.ModalButton, { title: 'Yes', className: 'btn-primary', onClick: function onClick() {
...
},{"./api-client/task-api-client":3,"./common/modal":7,"./common/table":11,"react":37,"react-dom":34}]},{},[41]);
