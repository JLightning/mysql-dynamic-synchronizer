...
var TaskApiClient = function (_AbstractClient) {
    ...
    _createClass(TaskApiClient, [{
        ...
        value: function createTaskActionFlat(taskId, taskName, mapping, source, target) {
            return this.postJson('/api/task/create', { taskId: taskId, taskName: taskName, mapping: mapping, source: source, target: target });
        }
    }, {
...
var ToolApiClient = function (_AbstractClient) {
    ...
    _createClass(ToolApiClient, [{
        ...
        value: function syncStructureFlat(taskId, taskName, mapping, source, target) {
            return this.postJson('/api/tool/sync-structure', { taskId: taskId, taskName: taskName, mapping: mapping, source: source, target: target });
        }
    }, {
        key: 'syncStructure',
...
var TaskCreate = function (_React$Component) {
    ...
    function TaskCreate(props) {
        ...
        _this.state = { taskName: '', fields: [], table: {}, readyForSubmit: false, filters: [], taskTypes: [], insertModes: [] };
    ...
    _createClass(TaskCreate, [{
        ...
        key: 'recalculateReadyForSubmit',
        value: function recalculateReadyForSubmit() {
            var readyForSubmit = this.state.fields.length > 0 && this.state.taskName !== '';
        ...
        value: function getMapping() {
            ...
            _mysqlApiClient2.default.getMappingFor2TableFlat(sourceParam.serverId, sourceParam.database, sourceParam.table, targetParam.serverId, targetParam.database, targetParam.table, mapping).done(function (data) {
                _this4.setState({ fields: data });
                _this4.recalculateReadyForSubmit();
            });
        }
    }, {
        key: 'handleMappableChange',
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'name', name: 'name',
                            defaultValue: this.state.taskName, onChange: function onChange(e) {
                                _this5.setState({ taskName: e.target.value });
                                _this5.recalculateReadyForSubmit();
