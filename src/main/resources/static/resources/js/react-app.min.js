    ...
    _createClass(TaskCreate, [{
            ...
            if (this.state.table.source != null && this.state.table.target != null) {
                ...
                $.ajax('/api/mysql/fields-mapping', {
                    ...
                    if (data.success) {
                        ...
                        _this2.recalculateReadyForSubmit();
                    }
                });
            } else {
                $.get('/api/mysql/fields', params).done(function (data) {
                    if (data.success) {
        ...
        value: function submit() {
            ...
            this.state.fields.filter(function (field) {
                ...
                return mapping.push({ sourceField: field.sourceField.field, targetField: field.targetField.field });
            });
            var postParams = {
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'name', name: 'name',
                            defaultValue: this.state.taskName, onChange: function onChange(e) {
                                _this3.setState({ taskName: e.target.value });
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col' },
                            _react2.default.createElement(TableSelector, { title: 'Source', onSelected: function onSelected(o) {
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col' },
                            _react2.default.createElement(TableSelector, { title: 'Target', onSelected: function onSelected(o) {
...
var TableSelector = function (_React$Component3) {
    ...
    function TableSelector(props) {
        ...
        var _this6 = _possibleConstructorReturn(this, (TableSelector.__proto__ || Object.getPrototypeOf(TableSelector)).call(this, props));

        _this6.state = { servers: [], databases: [], tables: [] };
        return _this6;
    }
    ...
    _createClass(TableSelector, [{
        ...
        value: function getServers() {
            ...
            $.get('/api/mysql/servers').done(function (data) {
                if (data.success) {
                    _this7.setState({ servers: data.data });
                }
            });
        }
    }, {
        ...
        value: function serverSelected(serverId) {
            ...
            $.get('/api/mysql/databases', { serverId: serverId }).done(function (data) {
                if (data.success) {
                    _this8.setState({ databases: data.data, serverId: serverId });
                }
            });
        }
    }, {
        ...
        value: function databaseSelected(databaseName) {
            ...
            $.get('/api/mysql/tables', { serverId: this.state.serverId, database: databaseName }).done(function (data) {
                if (data.success) {
                    _this9.setState({ tables: data.data, databaseName: databaseName });
                }
            });
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this10.serverSelected(option.id);
                    } }),
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this10.databaseSelected(option.value);
                    } }),
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    btnTitle: 'Select Database',
                    onItemClick: function onItemClick(option) {
                        _this10.setState({ tableName: option.value });
                        if (_this10.props.onSelected !== undefined) {
                            _this10.props.onSelected({
                                serverId: _this10.state.serverId,
                                databaseName: _this10.state.databaseName,
