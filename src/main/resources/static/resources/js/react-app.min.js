...
var AbstractClient = function () {
    ...
    _createClass(AbstractClient, [{
        key: 'baseHttpRequest',
        value: function baseHttpRequest(request) {
            var _done = null;
        ...
        key: 'postJson',
        value: function postJson(uri, data) {
        ...
        key: 'subscribe',
        value: function subscribe(uri, cb) {
            _wsClient2.default.subscribe(uri, cb);
        }
    }]);
...
},{"./ws-client":5}],2:[function(require,module,exports){
'use strict';
...
var _abstractClient = require('./abstract-client');

var _abstractClient2 = _interopRequireDefault(_abstractClient);
...
var MySQLApiClient = function (_AbstractClient) {
    _inherits(MySQLApiClient, _AbstractClient);

    function MySQLApiClient() {
        _classCallCheck(this, MySQLApiClient);

        return _possibleConstructorReturn(this, (MySQLApiClient.__proto__ || Object.getPrototypeOf(MySQLApiClient)).apply(this, arguments));
    }

    _createClass(MySQLApiClient, [{
        key: 'getDatabasesForServer',
        value: function getDatabasesForServer(serverId) {
            return this.get('/api/mysql/databases', { serverId: serverId });
        }
    }, {
        key: 'getFieldForServerDatabaseAndTable',
        value: function getFieldForServerDatabaseAndTable(serverId, database, table) {
            return this.get('/api/mysql/fields', { serverId: serverId, database: database, table: table });
        }
    }, {
        key: 'getMappingFor2TableFlat',
        value: function getMappingFor2TableFlat(sourceServerId, sourceDatabase, sourceTable, targetServerId, targetDatabase, targetTable, mapping) {
            return this.postJson('/api/mysql/fields-mapping', { sourceServerId: sourceServerId, sourceDatabase: sourceDatabase, sourceTable: sourceTable, targetServerId: targetServerId, targetDatabase: targetDatabase, targetTable: targetTable, mapping: mapping });
        }
    }, {
        key: 'getMappingFor2Table',
        value: function getMappingFor2Table(dto) {
        ...
        key: 'getTablesForServerAndDatabase',
        value: function getTablesForServerAndDatabase(serverId, database) {
            return this.get('/api/mysql/tables', { serverId: serverId, database: database });
        }
    }, {
        key: 'validateFilter',
        value: function validateFilter(serverId, database, table, filter) {
            return this.post('/api/mysql/validate-filter', { serverId: serverId, database: database, table: table, filter: filter });
        }
    }]);

    return MySQLApiClient;
}(_abstractClient2.default);

var mySQLApiClient = new MySQLApiClient();
exports.default = mySQLApiClient;

},{"./abstract-client":1}],3:[function(require,module,exports){
'use strict';
...
var TaskApiClient = function (_AbstractClient) {
    _inherits(TaskApiClient, _AbstractClient);

    function TaskApiClient() {
        _classCallCheck(this, TaskApiClient);

        return _possibleConstructorReturn(this, (TaskApiClient.__proto__ || Object.getPrototypeOf(TaskApiClient)).apply(this, arguments));
    }

    _createClass(TaskApiClient, [{
        key: 'createTaskActionFlat',
        value: function createTaskActionFlat(taskId, taskName, mapping, source, target, taskType, insertMode, filters) {
            return this.postJson('/api/task/create', { taskId: taskId, taskName: taskName, mapping: mapping, source: source, target: target, taskType: taskType, insertMode: insertMode, filters: filters });
        }
    }, {
        key: 'createTaskAction',
        value: function createTaskAction(dto) {
            return this.postJson('/api/task/create', dto);
        }
    }, {
        key: 'getFullMigrationTaskProgressWs',
        value: function getFullMigrationTaskProgressWs(taskId, callback) {
            return this.subscribe('/app/channel/task/full-migration-progress/' + taskId + '', callback);
        }
    }, {
        key: 'getIncrementalMigrationProgressWs',
        value: function getIncrementalMigrationProgressWs(taskId, callback) {
            return this.subscribe('/app/channel/task/incremental-migration-progress/' + taskId + '', callback);
        }
    }, {
        key: 'getInsertModes',
        value: function getInsertModes() {
            return this.get('/api/task/get-insert-modes', {});
        }
    }, {
        key: 'getTaskAction',
        value: function getTaskAction(taskId) {
        ...
        key: 'startFullMigrationTask',
        value: function startFullMigrationTask(taskId) {
            return this.get('/api/task/detail/' + taskId + '/start-full-migration', {});
        }
    }, {
        key: 'startIncrementalMigrationTask',
        value: function startIncrementalMigrationTask(taskId) {
            return this.get('/api/task/detail/' + taskId + '/start-incremental-migration', {});
        }
    }, {
        key: 'stopIncrementalMigrationTask',
        value: function stopIncrementalMigrationTask(taskId) {
            return this.get('/api/task/detail/' + taskId + '/stop-incremental-migration', {});
        }
    }, {
        key: 'truncateAndStartFullMigrationTask',
        value: function truncateAndStartFullMigrationTask(taskId) {
...
var taskApiClient = new TaskApiClient();
exports.default = taskApiClient;

},{"./abstract-client":1}],4:[function(require,module,exports){
'use strict';
...
var ToolApiClient = function (_AbstractClient) {
    _inherits(ToolApiClient, _AbstractClient);

    function ToolApiClient() {
        _classCallCheck(this, ToolApiClient);

        return _possibleConstructorReturn(this, (ToolApiClient.__proto__ || Object.getPrototypeOf(ToolApiClient)).apply(this, arguments));
    }

    _createClass(ToolApiClient, [{
        key: 'syncStructureFlat',
        value: function syncStructureFlat(taskId, taskName, mapping, source, target, taskType, insertMode, filters) {
            return this.postJson('/api/tool/sync-structure', { taskId: taskId, taskName: taskName, mapping: mapping, source: source, target: target, taskType: taskType, insertMode: insertMode, filters: filters });
        }
    }, {
        key: 'syncStructure',
        value: function syncStructure(dto) {
            return this.postJson('/api/tool/sync-structure', dto);
        }
    }]);

    return ToolApiClient;
}(_abstractClient2.default);

var toolApiClient = new ToolApiClient();
exports.default = toolApiClient;

},{"./abstract-client":1}],5:[function(require,module,exports){
'use strict';
...
var WsClient = function () {
    ...
    _createClass(WsClient, [{
        ...
        value: function onWsConnected() {
            ...
            this.connected = true;
            this.successCallback.forEach(function (cb) {
                return cb();
            });
        }
    }, {
        ...
        value: function onWsError() {
            this.connected = false;
            this.errorCallback.forEach(function (cb) {
                return cb();
            });
        }
    }, {
        key: 'connect',
        value: function connect(successCb, errorCb) {
            if (this.connected) {
                successCb();
            }
        ...
        value: function subscribe(channel, callback) {
            ...
            var r = function r() {
                return _this.stompClient.subscribe(channel, function (payload) {
        ...
        key: 'send',
        value: function send(channel, body1, body2) {
...
},{"@stomp/stompjs":13}],6:[function(require,module,exports){
'use strict';
...
var EditableText = function (_React$Component) {
    ...
    function EditableText(props) {
        ...
        _this.state = { editing: false, tmpValue: props.value || '' };
        return _this;
    }
        ...
        value: function render() {
            ...
            if (this.state.editing) {
                return _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement('input', { type: 'text', value: this.state.tmpValue,
                        onChange: function onChange(e) {
                            return _this2.setState({ tmpValue: e.target.value });
                        } }),
                    _react2.default.createElement('i', { className: 'fa fa-check-square-o ml-2 pointer', 'aria-hidden': 'true',
                        onClick: function onClick() {
                            _this2.props.updateValue(_this2.state.tmpValue);
                            _this2.setState({ editing: false });
                        } }),
                    _react2.default.createElement('i', { className: 'fa fa-close ml-2 pointer', 'aria-hidden': 'true',
...
var Modal = function (_React$Component) {
    ...
    _createClass(Modal, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'modal', tabIndex: '-1', role: 'dialog', ref: function ref(o) {
                        return _this2.modal = o;
                    } },
...
var ModalButton = exports.ModalButton = function (_React$Component2) {
    _inherits(ModalButton, _React$Component2);

    function ModalButton() {
        _classCallCheck(this, ModalButton);

        return _possibleConstructorReturn(this, (ModalButton.__proto__ || Object.getPrototypeOf(ModalButton)).apply(this, arguments));
    }
    ...
    _createClass(ModalButton, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'button',
                { type: 'button', className: "btn " + this.props.className, onClick: this.props.onClick,
                    'data-dismiss': 'modal' },
                this.props.children
            );
        }
...
var _mysqlApiClient = require('../api-client/mysql-api-client');

var _mysqlApiClient2 = _interopRequireDefault(_mysqlApiClient);
...
var RedisServerSelector = function (_React$Component) {
    _inherits(RedisServerSelector, _React$Component);

    function RedisServerSelector(props) {
        _classCallCheck(this, RedisServerSelector);

        var _this = _possibleConstructorReturn(this, (RedisServerSelector.__proto__ || Object.getPrototypeOf(RedisServerSelector)).call(this, props));

        _this.state = { servers: [] };
        return _this;
    }

    _createClass(RedisServerSelector, [{
        ...
        value: function getServers() {
            ...
            _mysqlApiClient2.default.getServers().done(function (data) {
                return _this2.setState({ servers: data });
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'row', key: 'server' },
                    _react2.default.createElement(_select2.default, { className: 'fullWidth col',
                        options: this.state.servers.map(function (server) {
                            return new _select.SelectOption(server.serverId, server.name + ' mysql://' + server.host + ':' + server.port);
                        }),
                        btnTitle: 'Select Server',
                        value: this.state.serverId,
                        onItemClick: function onItemClick(option) {
                            _this3.props.onSelected(option.id);
                        } })
                )
            );
        }
    ...
    return RedisServerSelector;
}(_react2.default.Component);

exports.default = RedisServerSelector;
...
},{"../api-client/mysql-api-client":2,"./select":9,"prop-types":34,"react":41}],9:[function(require,module,exports){
"use strict";
...
var Select = function (_React$Component) {
    ...
    _createClass(Select, [{
        ...
        value: function renderDropdownItems() {
            var _this2 = this;
            ...
            options.forEach(function (option) {
                result.push(_react2.default.createElement(
                    "a",
                    { key: option.id, className: "dropdown-item", href: "#",
                        onClick: function onClick() {
        ...
        value: function componentDidUpdate(prevProps) {
            ...
            if (this.props.options !== prevProps.options || this.props.value !== prevProps.value) {
                this.props.options.forEach(function (o) {
                    if (o.id === _this3.props.value) {
                        _this3.setState({ btnTitle: o.value });
                    }
                });
            }
        }
        ...
        key: "onItemClick",
        value: function onItemClick(option) {
        ...
        value: function render() {
            ...
            var className = 'dropdown-menu' + (this.state.show ? ' show' : '');
            return _react2.default.createElement(
                "div",
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: className, "aria-labelledby": "dropdownMenuButton" },
...
var SelectOption = exports.SelectOption = function SelectOption(id, value) {
...
},{"react":41}],10:[function(require,module,exports){
"use strict";
...
var _tableSelector = require("./table-selector");

var _tableSelector2 = _interopRequireDefault(_tableSelector);
...
var TableSelectorEditable = function (_TableSelector) {
    _inherits(TableSelectorEditable, _TableSelector);

    function TableSelectorEditable(props) {
        _classCallCheck(this, TableSelectorEditable);

        var _this = _possibleConstructorReturn(this, (TableSelectorEditable.__proto__ || Object.getPrototypeOf(TableSelectorEditable)).call(this, props));

        _this.state.showDone = true;
        return _this;
    }

    _createClass(TableSelectorEditable, [{
        key: "render",
        value: function render() {
            var _this2 = this;

            var doneBtn = '';
            var inputClass = 'col-12';
            if (this.state.showDone) {
                doneBtn = _react2.default.createElement(
                    "div",
                    { className: "col-2" },
                    _react2.default.createElement(
                        "a",
                        { className: "btn btn-primary text-white", onClick: function onClick(e) {
                                _this2.setState({ showDone: false });
                                if (_this2.props.onSelected !== undefined) {
                                    _this2.props.onSelected({
                                        serverId: _this2.state.serverId,
                                        database: _this2.state.database,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement("input", { type: "text", className: "form-control", placeholder: "New table name",
                            onChange: function onChange(e) {
                                return _this2.setState({ table: e.target.value });
                            } })
                    ),
                    doneBtn
                )
    ...
    return TableSelectorEditable;
}(_tableSelector2.default);

exports.default = TableSelectorEditable;

},{"./table-selector":11,"react":41}],11:[function(require,module,exports){
"use strict";
...
var TableSelector = function (_React$Component) {
    _inherits(TableSelector, _React$Component);

    function TableSelector(props) {
        _classCallCheck(this, TableSelector);

        var _this = _possibleConstructorReturn(this, (TableSelector.__proto__ || Object.getPrototypeOf(TableSelector)).call(this, props));

        _this.state = { servers: [], databases: [], tables: [], serverId: 0, database: '', table: '' };
        if (_this.props.table != null) {
            _this.state.serverId = _this.props.table.serverId;
            _this.state.database = _this.props.table.database;
            _this.state.table = _this.props.table.table;

            _this.serverSelected(_this.state.serverId);
            _this.databaseSelected(_this.state.database);
        }
        return _this;
    }

    _createClass(TableSelector, [{
        key: "componentDidMount",
        value: function componentDidMount() {
            this.getServers();
        }
        ...
        key: "serverSelected",
        value: function serverSelected(serverId) {
            var _this3 = this;

            _mysqlApiClient2.default.getDatabasesForServer(serverId).done(function (data) {
        ...
        value: function databaseSelected(database) {
            var _this4 = this;

            _mysqlApiClient2.default.getTablesForServerAndDatabase(this.state.serverId, database).done(function (data) {
        ...
        key: "renderServerAndDb",
        value: function renderServerAndDb() {
            var _this5 = this;
            ...
            return [_react2.default.createElement(
                ...
                _react2.default.createElement(_select2.default, { className: "fullWidth col",
                    ...
                    value: this.state.serverId,
                    onItemClick: function onItemClick(option) {
                        return _this5.serverSelected(option.id);
                    } })
            ), _react2.default.createElement(
                "div",
                { className: "row", key: "db" },
                _react2.default.createElement(_select2.default, { className: "mt-3 fullWidth col",
                    options: this.state.databases.map(function (db) {
                        return new _select.SelectOption(db, db);
                    }),
                    btnTitle: 'Select Database',
                    value: this.state.database,
                    onItemClick: function onItemClick(option) {
                        return _this5.databaseSelected(option.value);
                    } })
            )];
        }
    }, {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { className: "row" },
                    _react2.default.createElement(_select2.default, { className: "mt-3 fullWidth col",
                        options: this.state.tables.map(function (table) {
                            return new _select.SelectOption(table, table);
                        }),
                        btnTitle: 'Select Table',
                        value: this.state.table,
                        onItemClick: function onItemClick(option) {
                            _this6.setState({ table: option.value });
                            if (_this6.props.onSelected !== undefined) {
                                _this6.props.onSelected({
                                    serverId: _this6.state.serverId,
                                    database: _this6.state.database,
                                    table: option.value
                                });
                            }
                        } })
...
},{"../api-client/mysql-api-client":2,"./select":9,"prop-types":34,"react":41}],12:[function(require,module,exports){
'use strict';
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'tr',
                        null,
                        this.props.th.map(function (_th, idx) {
                            return _react2.default.createElement(
                                'th',
                                { scope: 'col', key: idx },
                                _th
...
},{"react":41}],13:[function(require,module,exports){
...
},{"./lib/stomp.js":14,"websocket":42}],14:[function(require,module,exports){
...
},{"./lib/ReactPropTypesSecret":35,"_process":30}],32:[function(require,module,exports){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./checkPropTypes":31,"./lib/ReactPropTypesSecret":35,"_process":30,"object-assign":29}],34:[function(require,module,exports){
(function (process){
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
...
},{"fbjs/lib/ExecutionEnvironment":15,"fbjs/lib/containsNode":18,"fbjs/lib/emptyFunction":19,"fbjs/lib/emptyObject":20,"fbjs/lib/getActiveElement":21,"fbjs/lib/invariant":24,"fbjs/lib/shallowEqual":27,"object-assign":29,"react":41}],38:[function(require,module,exports){
(function (process){
'use strict';
...
},{"_process":30,"fbjs/lib/emptyFunction":19,"fbjs/lib/emptyObject":20,"fbjs/lib/invariant":24,"fbjs/lib/warning":28,"object-assign":29,"prop-types/checkPropTypes":31}],40:[function(require,module,exports){
/** @license React v16.4.1
...
},{"fbjs/lib/emptyFunction":19,"fbjs/lib/emptyObject":20,"fbjs/lib/invariant":24,"object-assign":29}],41:[function(require,module,exports){
(function (process){
'use strict';
...
module.exports={
  "_args": [
    [
      ...
      "/code/main/resources/static/resources/js/source/node_modules/stompjs"
    ]
  ],
  ...
  "_where": "/code/main/resources/static/resources/js/source/node_modules/stompjs",
  "author": {
    "name": "Brian McKelvey",
...
require('./task/task-create-chooser.js');

require('./task/mysql2mysql/task-detail.js');

require('./table-structure-sync.js');

},{"./table-structure-sync.js":46,"./task/mysql2mysql/task-detail.js":48,"./task/task-create-chooser.js":50}],46:[function(require,module,exports){
"use strict";
...
var _tableSelector = require("./common/table-selector");

var _tableSelector2 = _interopRequireDefault(_tableSelector);

var _tableSelectorEditable = require("./common/table-selector-editable");

var _tableSelectorEditable2 = _interopRequireDefault(_tableSelectorEditable);
...
var _editableText = require("./common/editable-text");

var _editableText2 = _interopRequireDefault(_editableText);

var _toolApiClient = require("./api-client/tool-api-client");

var _toolApiClient2 = _interopRequireDefault(_toolApiClient);
...
var TableStructureSync = function (_React$Component) {
    _inherits(TableStructureSync, _React$Component);

    function TableStructureSync(props) {
        _classCallCheck(this, TableStructureSync);

        var _this = _possibleConstructorReturn(this, (TableStructureSync.__proto__ || Object.getPrototypeOf(TableStructureSync)).call(this, props));

        _this.state = { fields: [], table: {}, readyForSubmit: true };
        return _this;
    }

    _createClass(TableStructureSync, [{
        key: "tableSelected",
        value: function tableSelected(params, isSource) {
            var _this2 = this;

            var sub2 = isSource ? 'source' : 'target';
            ...
            if (isSource) {
                _mysqlApiClient2.default.getFieldForServerDatabaseAndTable(params.serverId, params.database, params.table).done(function (data) {
                    var fields = [];
        ...
        key: "updateTargetField",
        value: function updateTargetField(value, idx) {
            var fields = this.state.fields;
            fields[idx].targetField = value;
            this.setState({ fields: fields });
        }
    }, {
        key: "handleMappableChange",
        value: function handleMappableChange(e, idx) {
            var fields = this.state.fields;
        ...
        value: function submit() {
            var mapping = this.state.fields.filter(function (field) {
            ...
            _toolApiClient2.default.syncStructure(postParams).done(function (data) {
                return alert(data);
            });
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "col" },
                        _react2.default.createElement(_tableSelector2.default, { table: this.state.table.source, title: "Source",
                            onSelected: function onSelected(o) {
                                return _this3.tableSelected(o, true);
                            } })
                    ),
                    _react2.default.createElement(
                        "div",
                        { className: "col" },
                        _react2.default.createElement(_tableSelectorEditable2.default, { table: this.state.table.target, title: "Target",
                            onSelected: function onSelected(o) {
                                return _this3.tableSelected(o, false);
                            } })
                    )
                ),
                this.state.fields.length > 0 ? _react2.default.createElement(
                    _table2.default,
                    { th: ['Source Fields', 'Sync?', 'Target Fields'], className: "mt-3" },
                    this.state.fields.map(function (field, idx) {
                        return _react2.default.createElement(FieldRow, { field: field, key: idx,
                            updateTargetField: function updateTargetField(value) {
                                return _this3.updateTargetField(value, idx);
                            },
                            handleMappableChange: function handleMappableChange(e) {
                                return _this3.handleMappableChange(e, idx);
                            } });
                    })
                ) : '',
                _react2.default.createElement(
                    "button",
                    { type: "button", className: "btn btn-primary float-right mt-3",
    ...
    return TableStructureSync;
}(_react2.default.Component);

var FieldRow = function (_React$Component2) {
    _inherits(FieldRow, _React$Component2);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "td",
                    null,
                    _react2.default.createElement("input", { type: "checkbox", checked: field.mappable,
                        onChange: function onChange(e) {
                            return _this5.props.handleMappableChange(e);
                        } })
                ),
                _react2.default.createElement(
                    "td",
                    null,
                    _react2.default.createElement(_editableText2.default, { updateValue: this.props.updateTargetField, value: field.targetField })
                )
            );
        }
    }]);
...
if (document.getElementById('tableStructureSyncWrapper') !== null) {
    _reactDom2.default.render(_react2.default.createElement(TableStructureSync, null), document.getElementById('tableStructureSyncWrapper'));
}

},{"./api-client/mysql-api-client":2,"./api-client/tool-api-client":4,"./common/editable-text":6,"./common/table":12,"./common/table-selector":11,"./common/table-selector-editable":10,"react":41,"react-dom":38}],47:[function(require,module,exports){
'use strict';
...
var _taskApiClient = require('../../api-client/task-api-client');

var _taskApiClient2 = _interopRequireDefault(_taskApiClient);
...
var TaskCreate = function (_React$Component) {
    ...
    function TaskCreate(props) {
        ...
        var _this = _possibleConstructorReturn(this, (TaskCreate.__proto__ || Object.getPrototypeOf(TaskCreate)).call(this, props));
        ...
        if (typeof taskDTO !== 'undefined') {
            _this.taskDTO = taskDTO;
            _this.state.taskName = taskDTO.taskName;
            _this.state.table.source = taskDTO.source;
            _this.state.table.target = taskDTO.target;
            _this.state.taskType = taskDTO.taskType;
            _this.state.insertMode = taskDTO.insertMode;
            _this.state.filters = taskDTO.filters;
    ...
    _createClass(TaskCreate, [{
        ...
        value: function componentDidMount() {
            ...
            _taskApiClient2.default.getTaskTypes().done(function (taskTypes) {
                return _this2.setState({ taskTypes: taskTypes });
            });
            _taskApiClient2.default.getInsertModes().done(function (insertModes) {
                return _this2.setState({ insertModes: insertModes });
            });
        }
    }, {
        key: 'getReadyToSubmit',
        value: function getReadyToSubmit() {
        ...
        value: function tableSelected(params, isSource) {
            ...
            var sub = isSource ? 'sourceField' : 'targetField';
            var sub2 = isSource ? 'source' : 'target';
        ...
        value: function getMapping() {
            ...
            var sourceParam = this.state.table.source;
            var targetParam = this.state.table.target;

            var mapping = typeof this.taskDTO !== 'undefined' ? this.taskDTO.mapping : null;
            _mysqlApiClient2.default.getMappingFor2TableFlat(sourceParam.serverId, sourceParam.database, sourceParam.table, targetParam.serverId, targetParam.database, targetParam.table, mapping).done(function (fields) {
                return _this4.setState({ fields: fields });
            });
        }
    }, {
        key: 'handleMappableChange',
        ...
        value: function submit() {
            var state = this.state;
            var mapping = state.fields.filter(function (field) {
                return field.mappable;
            }).map(function (field) {
                return { sourceField: field.sourceField, targetField: field.targetField };
            });
            ...
            _taskApiClient2.default.createTaskAction(postParams).done(function (data) {
                location.href = DOMAIN + '/task/detail/?taskId=' + data.taskId;
            });
        }
    }, {
        key: 'swapField',
        value: function swapField(dragField, dropField) {
            var fields = this.state.fields;
            var dragFieldIdx = fields.indexOf(dragField);
            var dropFieldIdx = fields.indexOf(dropField);

            if (dragFieldIdx === dropFieldIdx) return;

            var tmp = fields[dragFieldIdx].sourceField;
        ...
        key: 'editField',
        value: function editField(idx, fieldName) {
            var fields = this.state.fields;
        ...
        value: function render() {
            ...
            var readyToSubmit = this.getReadyToSubmit();
            var state = this.state;
            return _react2.default.createElement(
                'div',
                { className: 'container mt-3' },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'h4',
                        null,
                        'Choose Source and Target table'
                    ),
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'name', name: 'name', placeholder: 'Enter Task Name',
                            defaultValue: this.state.taskName,
                            onChange: function onChange(e) {
                                return _this5.setState({ taskName: e.target.value });
                            } })
                    ),
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(_select2.default, { className: 'fullWidth', btnTitle: 'Select Task Type',
                                    options: this.state.taskTypes.map(function (type, idx) {
                                        return new _select.SelectOption(idx, type);
                                    }),
                                    onItemClick: function onItemClick(o) {
                                        return _this5.setState({ taskType: o.value });
                                    },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(_select2.default, { className: 'fullWidth', btnTitle: 'Select Insert Mode',
                                    options: this.state.insertModes.map(function (mode, idx) {
                                        return new _select.SelectOption(idx, mode);
                                    }),
                                    onItemClick: function onItemClick(o) {
                                        return _this5.setState({ insertMode: o.value });
                                    },
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_tableSelector2.default, { table: this.state.table.source, title: 'Source',
                                onSelected: function onSelected(o) {
                                    return _this5.tableSelected(o, true);
                                } })
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: 'col' },
                            _react2.default.createElement(_tableSelector2.default, { table: this.state.table.target, title: 'Target',
                                onSelected: function onSelected(o) {
                                    return _this5.tableSelected(o, false);
                                } })
                        )
                    ),
                    _react2.default.createElement(
                    ...
                    this.state.fields.length > 0 ? _react2.default.createElement(
                        _table2.default,
                        { th: ['Source Fields', 'Sync?', 'Target Fields'], className: 'mt-3' },
                        _react2.default.createElement(FieldRowList, {
                            fields: this.state.fields,
                            handleMappableChange: function handleMappableChange(e, idx) {
                                return _this5.handleMappableChange(e, idx);
                            },
                    ...
                    _react2.default.createElement(TaskFilter, { filters: this.state.filters, addFilter: function addFilter(filter, cb) {
                            _mysqlApiClient2.default.validateFilter(state.table.source.serverId, state.table.source.database, state.table.source.table, filter).done(function (data) {
                                var filters = _this5.state.filters;
                                filters.push(data);
...
var TaskFilter = function (_React$Component2) {
    _inherits(TaskFilter, _React$Component2);

    function TaskFilter(props) {
        _classCallCheck(this, TaskFilter);

        var _this6 = _possibleConstructorReturn(this, (TaskFilter.__proto__ || Object.getPrototypeOf(TaskFilter)).call(this, props));

        _this6.state = { filters: _this6.props.filters || [], inputValue: '' };
        return _this6;
    }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.state.filters.map(function (filter, idx) {
                        return _react2.default.createElement(
                            'span',
                            { key: idx, className: 'filter btn btn-secondary btn-sm mr-2',
                                onClick: function onClick(idx) {
                                    return _this7.props.removeFilter(idx);
                                } },
                            _react2.default.createElement(
                                'span',
                                null,
                            ...
                            _react2.default.createElement('i', { className: 'fa fa-close ml-2', 'aria-hidden': 'true' })
                        );
                    })
                ),
                _react2.default.createElement('input', { type: 'text', className: 'form-control mt-2', id: 'filter', name: 'filter', placeholder: 'Enter Task Name',
                    onKeyPress: function onKeyPress(e) {
                        if (e.key === 'Enter') {
                            var value = e.target.value;
                            if (value.trim() !== '') {
                                _this7.props.addFilter(value, function () {
                                    return _this7.setState({ inputValue: '' });
                                });
                            }
                            return;
                        }
                    ...
                    onChange: function onChange(e) {
                        return _this7.setState({ inputValue: e.target.value });
                    } })
            );
        }
    }]);
...
var FieldRowList = function (_React$Component3) {
    _inherits(FieldRowList, _React$Component3);

    function FieldRowList() {
        _classCallCheck(this, FieldRowList);

        return _possibleConstructorReturn(this, (FieldRowList.__proto__ || Object.getPrototypeOf(FieldRowList)).apply(this, arguments));
    }

    _createClass(FieldRowList, [{
        key: 'captureDrapStartField',
        value: function captureDrapStartField(field) {
            this.setState({ capturedField: field });
        }
    }, {
        key: 'onDrop',
        value: function onDrop(field) {
        ...
        value: function render() {
            ...
            return this.props.fields.map(function (field, idx) {
                return _react2.default.createElement(FieldRow, _extends({
                    key: idx,
                    idx: idx,
                    field: field
                }, _this9.props, {
                    onDrop: _this9.onDrop.bind(_this9),
                    captureDrapStartField: _this9.captureDrapStartField.bind(_this9)
                }));
            });
        }
    }]);
...
var FieldRow = function (_React$Component4) {
    _inherits(FieldRow, _React$Component4);

    function FieldRow(props) {
        _classCallCheck(this, FieldRow);

        var _this10 = _possibleConstructorReturn(this, (FieldRow.__proto__ || Object.getPrototypeOf(FieldRow)).call(this, props));

        _this10.state = { dropTargetClass: '', custom: false };
        return _this10;
    }
    ...
    _createClass(FieldRow, [{
        ...
        value: function getSourceText() {
            ...
            var field = this.props.field;
            if (this.state.custom) return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement('input', { type: 'text', value: field.sourceField,
                    onChange: function onChange(e) {
                        return _this11.props.editField(_this11.props.idx, e.target.value);
                    } }),
                _react2.default.createElement('i', { className: 'fa fa-check-square-o ml-2', 'aria-hidden': 'true',
                    onClick: function onClick() {
                        return _this11.setState({ custom: false });
                    } })
            );
            return _react2.default.createElement(
                'div',
                { onClick: function onClick() {
                        return _this11.setState({ custom: true });
                    },
                    style: { minHeight: '1.5rem' } },
                field.sourceField
            );
        ...
        value: function render() {
            ...
            var field = this.props.field;
            var sourceText = this.getSourceText();
            return _react2.default.createElement(
                'tr',
                null,
                _react2.default.createElement(
                    'td',
                    { className: this.state.dropTargetClass + ' pointer',
                        draggable: 'true',
                        onDragStart: function onDragStart() {
                            _this12.setState({ dropTargetClass: 'bg-success text-white' });
                            _this12.props.captureDrapStartField(field);
                        },
                        onDrop: function onDrop() {
                            _this12.onDrop();
                            _this12.props.onDrop(field);
                        },
                        onDragOver: function onDragOver(e) {
                            return _this12.onDragOver(e);
                        },
                        onDragLeave: function onDragLeave(e) {
                            return _this12.onDragLeave(e);
                        }
                    },
                    sourceText
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'checkbox', checked: field.mappable,
                        onChange: function onChange(e) {
                            return _this12.props.handleMappableChange(e, _this12.props.idx);
                        } })
                ),
                field.targetField == null ? _react2.default.createElement('td', null) : _react2.default.createElement(
                    'td',
                    null,
                    field.targetField
                )
...
},{"../../api-client/mysql-api-client":2,"../../api-client/task-api-client":3,"../../common/select":9,"../../common/table":12,"../../common/table-selector":11,"react":41}],48:[function(require,module,exports){
'use strict';
...
var TaskDetail = function (_React$Component) {
    ...
    _createClass(TaskDetail, [{
        ...
        value: function componentDidMount() {
            ...
            _taskApiClient2.default.getFullMigrationTaskProgressWs(taskId, function (event) {
                if (_this2.state.fullMigrationProgress !== event.progress) {
                    _this2.setState({ fullMigrationProgress: event.progress });
                }
                if (_this2.state.fullMigrationRunning !== event.running) {
                    _this2.setState({ fullMigrationRunning: event.running });
                }
            });

            _taskApiClient2.default.getIncrementalMigrationProgressWs(taskId, function (event) {
                if (event.delta) {
                    _this2.setState({
                        incrementalMigrationRunning: event.running, incrementalMigrationProgress: {
                            insertCount: event.insertCount + _this2.state.incrementalMigrationProgress.insertCount,
                            updateCount: event.updateCount + _this2.state.incrementalMigrationProgress.updateCount,
                            deleteCount: event.deleteCount + _this2.state.incrementalMigrationProgress.deleteCount
                        }
                    });
                } else {
                    _this2.setState({
            ...
            _taskApiClient2.default.getTaskAction(taskId).done(function (data) {
                return _this2.setState({ task: data });
            });
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            if (this.state.task == null) return _react2.default.createElement(
                'p',
                null,
                'Loading...'
            );
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_modal2.default, { ref: function ref(o) {
                        return _this3.confirmTruncateModal = o;
                    }, title: 'Confirm Truncate', content: _react2.default.createElement(
                        'p',
                        null,
                        ...
                        _react2.default.createElement(
                            _modal.ModalButton,
                            { className: 'btn-primary ml-1', onClick: function onClick() {
                                    return _taskApiClient2.default.truncateAndStartFullMigrationTask(taskId);
                                } },
                            'Yes'
                        )
                    ) }),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'p',
                            null,
                            'Task type: MySQL to MySQL full migration and incremental migration'
                        )
                    )
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-3 pl-3 vertial-center' },
                        _react2.default.createElement(
                            'div',
                            null,
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-7 vertial-center' },
                        _react2.default.createElement(
                            'div',
                            { className: 'progress ml-1', style: { height: "24px" } },
                            _react2.default.createElement(
                                'div',
                                { className: 'progress-bar progress-bar-striped progress-bar-animated', role: 'progressbar',
                                    'aria-valuenow': '75', 'aria-valuemin': '0', 'aria-valuemax': '100',
                                    style: { width: this.state.fullMigrationProgress + '%' } },
                                this.state.fullMigrationProgress,
                                '%'
                            )
                        )
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'col-2 vertial-center' },
                        function () {
                            if (_this3.state.fullMigrationRunning) return _react2.default.createElement(
                                'button',
                                { type: 'button',
                            ...
                            return _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { type: 'button', className: 'float-right btn btn-primary btn-sm',
                                        onClick: function onClick() {
                                            return _taskApiClient2.default.startFullMigrationTask(taskId);
                                        } },
                                    'Start'
                                ),
                                _react2.default.createElement(
                                    'button',
                                    { type: 'button', className: 'float-right btn btn-primary btn-sm mr-1',
                                        onClick: function onClick() {
                                            return _this3.confirmTruncateModal.show();
                                        } },
                                    'Truncate and start'
                                )
                            );
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            this.state.task.mapping.map(function (o) {
                                return _react2.default.createElement(
                                    'tr',
                                    null,
                                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            _table2.default,
                            { th: ["Filter"] },
                            this.state.task.filters.map(function (o) {
                                return _react2.default.createElement(
                                    'tr',
                                    null,
                                    _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                { className: 'col-6' },
                                function () {
                                    if (_this3.state.incrementalMigrationRunning) return _react2.default.createElement(
                                        'button',
                                        { type: 'button',
                                            className: 'float-right btn btn-primary btn-sm ml-1',
                                            onClick: function onClick() {
                                                return _taskApiClient2.default.stopIncrementalMigrationTask(taskId);
                                            } },
                                        'Stop'
                                    );
                                    return _react2.default.createElement(
                                        ...
                                        { type: 'button', className: 'float-right btn btn-primary btn-sm',
                                            onClick: function onClick() {
                                                return _taskApiClient2.default.startIncrementalMigrationTask(taskId);
                                            } },
                                        'Start'
                                    );
                                }()
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    this.state.incrementalMigrationProgress.insertCount
                                ),
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    this.state.incrementalMigrationProgress.updateCount
                                ),
                                _react2.default.createElement(
                                    'td',
                                    null,
                                    this.state.incrementalMigrationProgress.deleteCount
                                )
                            )
                        )
                    )
...
if (document.getElementById('taskDetailWrapper') !== null) {
    _reactDom2.default.render(_react2.default.createElement(TaskDetail, null), document.getElementById('taskDetailWrapper'));
}

},{"../../api-client/task-api-client":3,"../../common/modal":7,"../../common/table":12,"react":41,"react-dom":38}],49:[function(require,module,exports){
"use strict";
...
var _redisServerSelector = require("../../common/redis-server-selector");

var _redisServerSelector2 = _interopRequireDefault(_redisServerSelector);
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "div",
                            { className: "col" },
                            _react2.default.createElement(_redisServerSelector2.default, { title: "Target", onSelected: console.log })
                        )
                    ),
                    _react2.default.createElement(
                        "h4",
...
var FieldRowList = function (_React$Component2) {
    _inherits(FieldRowList, _React$Component2);
        ...
        value: function render() {
            ...
            return this.props.fields.map(function (field, idx) {
                return _react2.default.createElement(FieldRow, _extends({
                    ...
                    onDrop: _this7.onDrop.bind(_this7),
                    captureDrapStartField: _this7.captureDrapStartField.bind(_this7)
                }));
            });
        }
    }]);
...
var FieldRow = function (_React$Component3) {
    _inherits(FieldRow, _React$Component3);

    function FieldRow(props) {
        _classCallCheck(this, FieldRow);

        var _this8 = _possibleConstructorReturn(this, (FieldRow.__proto__ || Object.getPrototypeOf(FieldRow)).call(this, props));

        _this8.state = { dropTargetClass: '', custom: false };
        return _this8;
    }
    ...
    _createClass(FieldRow, [{
        ...
        value: function getSourceText() {
            ...
            if (this.state.custom) return _react2.default.createElement(
                ...
                _react2.default.createElement("input", { type: "text", value: field.sourceField,
                    onChange: function onChange(e) {
                        return _this9.props.editField(_this9.props.idx, e.target.value);
                    } }),
                _react2.default.createElement("i", { className: "fa fa-check-square-o ml-2", "aria-hidden": "true",
                    onClick: function onClick() {
                        return _this9.setState({ custom: false });
                    } })
            );
            return _react2.default.createElement(
                "div",
                { onClick: function onClick() {
                        return _this9.setState({ custom: true });
                    },
                    style: { minHeight: '1.5rem' } },
                field.sourceField
            );
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    { className: this.state.dropTargetClass + ' pointer',
                        draggable: "true",
                        onDragStart: function onDragStart() {
                            _this10.setState({ dropTargetClass: 'bg-success text-white' });
                            _this10.props.captureDrapStartField(field);
                        },
                        onDrop: function onDrop() {
                            _this10.onDrop();
                            _this10.props.onDrop(field);
                        },
                        onDragOver: function onDragOver(e) {
                            return _this10.onDragOver(e);
                        },
                        onDragLeave: function onDragLeave(e) {
                            return _this10.onDragLeave(e);
                        }
                    },
                    sourceText
                ),
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", { type: "checkbox", checked: field.mappable,
                        onChange: function onChange(e) {
                            return _this10.props.handleMappableChange(e, _this10.props.idx);
                        } })
                ),
                field.targetField == null ? _react2.default.createElement("td", null) : _react2.default.createElement(
                    "td",
...
},{"../../api-client/mysql-api-client":2,"../../api-client/task-api-client":3,"../../common/redis-server-selector":8,"../../common/select":9,"../../common/table":12,"../../common/table-selector":11,"react":41}],50:[function(require,module,exports){
"use strict";
...
var _taskCreate = require("./mysql2mysql/task-create");

var _taskCreate2 = _interopRequireDefault(_taskCreate);

var _taskCreate3 = require("./mysql2redis/task-create");

var _taskCreate4 = _interopRequireDefault(_taskCreate3);
...
var TaskCreateChooser = function (_React$Component) {
    _inherits(TaskCreateChooser, _React$Component);

    function TaskCreateChooser(props) {
        _classCallCheck(this, TaskCreateChooser);

        var _this = _possibleConstructorReturn(this, (TaskCreateChooser.__proto__ || Object.getPrototypeOf(TaskCreateChooser)).call(this, props));

        _this.state = { type: '' };
        return _this;
    }

    _createClass(TaskCreateChooser, [{
        key: "setType",
        value: function setType(e, type) {
            e.preventDefault();
        ...
        value: function render() {
            ...
            switch (this.state.type) {
                case type.MYSQL_2_MYSQL:
                    return _react2.default.createElement(_taskCreate2.default, null);
                case type.MYSQL_2_REDIS:
                    return _react2.default.createElement(_taskCreate4.default, null);
                default:
                    return _react2.default.createElement(
                        "div",
                        ...
                        _react2.default.createElement(
                            ...
                            { href: "#", className: "list-group-item list-group-item-action",
                                onClick: function onClick(e) {
                                    return _this2.setType(e, type.MYSQL_2_MYSQL);
                                } },
                            "MySQL to MySQL"
                        ),
                        _react2.default.createElement(
                            ...
                            { href: "#", className: "list-group-item list-group-item-action",
                                onClick: function onClick(e) {
                                    return _this2.setType(e, type.MYSQL_2_REDIS);
                                } },
                            "MySQL to Redis"
                        )
                    );
    ...
    return TaskCreateChooser;
}(_react2.default.Component);

if (document.getElementById('taskCreateWrapper') !== null) {
    _reactDom2.default.render(_react2.default.createElement(TaskCreateChooser, null), document.getElementById('taskCreateWrapper'));
}

},{"./mysql2mysql/task-create":47,"./mysql2redis/task-create":49,"react":41,"react-dom":38}]},{},[45]);
