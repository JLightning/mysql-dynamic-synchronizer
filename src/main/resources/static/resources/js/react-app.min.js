...
var FieldRow = function (_React$Component3) {
    ...
    _createClass(FieldRow, [{
        ...
        value: function getSourceText() {
            ...
            if (this.state.custom) return _react2.default.createElement('input', { type: 'text', value: field.sourceField });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'td',
                    { className: this.state.dropTargetClass,
                        draggable: 'true',
                        onDragStart: function onDragStart() {
                            _this8.setState({ dropTargetClass: 'bg-success text-white' });
                            _this8.props.captureDrapStartField(field);
                        },
                        onDrop: function onDrop() {
                            _this8.onDrop();
                            _this8.props.onDrop(field);
                        },
                        onDragOver: function onDragOver(e) {
                            return _this8.onDragOver(e);
                        },
                        onDragLeave: function onDragLeave(e) {
                            return _this8.onDragLeave(e);
                        }
                    },
                    sourceText,
                    _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'td',
                    null,
                    _react2.default.createElement('input', { type: 'checkbox', checked: field.mappable, onChange: function onChange(e) {
                            return _this8.props.handleMappableChange(e);
                        } })
                ),
...
var TableSelector = function (_React$Component4) {
    ...
    function TableSelector(props) {
        ...
        var _this9 = _possibleConstructorReturn(this, (TableSelector.__proto__ || Object.getPrototypeOf(TableSelector)).call(this, props));

        _this9.state = { servers: [], databases: [], tables: [], serverId: 0, databaseName: '', tableName: '' };
        if (_this9.props.table != null) {
            _this9.state.serverId = _this9.props.table.serverId;
            _this9.state.databaseName = _this9.props.table.database;
            _this9.state.tableName = _this9.props.table.table;

            _this9.serverSelected(_this9.state.serverId);
            _this9.databaseSelected(_this9.state.databaseName);
        }
        return _this9;
    }
    ...
    _createClass(TableSelector, [{
        ...
        value: function getServers() {
            ...
            $.get(DOMAIN + '/api/mysql/servers').done(function (data) {
                if (data.success) {
                    _this10.setState({ servers: data.data });
                }
            });
        }
    }, {
        ...
        value: function serverSelected(serverId) {
            ...
            $.get(DOMAIN + '/api/mysql/databases', { serverId: serverId }).done(function (data) {
                if (data.success) {
                    _this11.setState({ databases: data.data, serverId: serverId });
                }
            });
        }
    }, {
        ...
        value: function databaseSelected(databaseName) {
            ...
            $.get(DOMAIN + '/api/mysql/tables', { serverId: this.state.serverId, database: databaseName }).done(function (data) {
                if (data.success) {
                    _this12.setState({ tables: data.data, databaseName: databaseName });
                }
            });
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this13.serverSelected(option.id);
                    } }),
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this13.databaseSelected(option.value);
                    } }),
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        _this13.setState({ tableName: option.value });
                        if (_this13.props.onSelected !== undefined) {
                            _this13.props.onSelected({
                                serverId: _this13.state.serverId,
                                databaseName: _this13.state.databaseName,
