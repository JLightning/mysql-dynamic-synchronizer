...
},{"./task-create.js":27,"./task-detail.js":28}],27:[function(require,module,exports){
'use strict';
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col' },
                            _react2.default.createElement(TableSelector, { table: this.state.table.source, title: 'Source',
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col' },
                            _react2.default.createElement(TableSelector, { table: this.state.table.target, title: 'Target',
                                onSelected: function onSelected(o) {
...
var TableSelector = function (_React$Component5) {
    _inherits(TableSelector, _React$Component5);

    function TableSelector(props) {
        _classCallCheck(this, TableSelector);

        var _this12 = _possibleConstructorReturn(this, (TableSelector.__proto__ || Object.getPrototypeOf(TableSelector)).call(this, props));

        _this12.state = { servers: [], databases: [], tables: [], serverId: 0, databaseName: '', tableName: '' };
        if (_this12.props.table != null) {
            _this12.state.serverId = _this12.props.table.serverId;
            _this12.state.databaseName = _this12.props.table.database;
            _this12.state.tableName = _this12.props.table.table;

            _this12.serverSelected(_this12.state.serverId);
            _this12.databaseSelected(_this12.state.databaseName);
        }
        return _this12;
    }
    ...
    _createClass(TableSelector, [{
        ...
        value: function getServers() {
            ...
            $.get(DOMAIN + '/api/mysql/servers').done(function (data) {
                if (data.success) {
                    _this13.setState({ servers: data.data });
                }
            });
        }
    }, {
        ...
        value: function serverSelected(serverId) {
            ...
            $.get(DOMAIN + '/api/mysql/databases', { serverId: serverId }).done(function (data) {
                if (data.success) {
                    _this14.setState({ databases: data.data, serverId: serverId });
                }
            });
        }
    }, {
        ...
        value: function databaseSelected(databaseName) {
            ...
            $.get(DOMAIN + '/api/mysql/tables', { serverId: this.state.serverId, database: databaseName }).done(function (data) {
                if (data.success) {
                    _this15.setState({ tables: data.data, databaseName: databaseName });
                }
            });
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this16.serverSelected(option.id);
                    } }),
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this16.databaseSelected(option.value);
                    } }),
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        _this16.setState({ tableName: option.value });
                        if (_this16.props.onSelected !== undefined) {
                            _this16.props.onSelected({
                                serverId: _this16.state.serverId,
                                databaseName: _this16.state.databaseName,
...
},{"./common/select":1,"react":25,"react-dom":22}],28:[function(require,module,exports){
'use strict';
