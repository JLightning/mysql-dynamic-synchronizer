...
var TaskDetail = function (_React$Component) {
    ...
    function TaskDetail(props) {
        ...
        _this.state = { fullMigrationProgress: 0, fullMigrationRunning: false, incrementalMigrationRunning: false };
        return _this;
    }
    ...
    _createClass(TaskDetail, [{
        ...
        value: function componentDidMount() {
            ...
            _taskApiClient2.default.getIncrementalMigrationProgressWs(taskId, function (event) {
                _this2.setState({ incrementalMigrationRunning: event.running });
            });
