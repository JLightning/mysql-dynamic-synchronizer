                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col' },
                            _react2.default.createElement(TableSelector, { table: this.state.table.source, title: 'Source', onSelected: function onSelected(o) {
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'col' },
                            _react2.default.createElement(TableSelector, { table: this.state.table.target, title: 'Target', onSelected: function onSelected(o) {
                    ...
                    this.state.fields.length > 0 ? _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            this.state.fields.map(function (field, idx) {
                                return _react2.default.createElement(FieldRow, { key: idx, field: field,
    ...
    _createClass(FieldRow, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'tr',
                null,
                field.sourceField == null ? _react2.default.createElement('td', null) : _react2.default.createElement(
                    'td',
                    null,
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'checkbox', defaultChecked: field.mappable,
                        onChange: function onChange(e) {
                            return _this6.props.handleMappableChange(e);
                        } })
                ),
...
var TableSelector = function (_React$Component3) {
    _inherits(TableSelector, _React$Component3);

    function TableSelector(props) {
        _classCallCheck(this, TableSelector);

        var _this7 = _possibleConstructorReturn(this, (TableSelector.__proto__ || Object.getPrototypeOf(TableSelector)).call(this, props));

        _this7.state = { servers: [], databases: [], tables: [], serverId: 0, databaseName: '', tableName: '' };
        if (_this7.props.table != null) {
            _this7.state.serverId = _this7.props.table.serverId;
            _this7.state.databaseName = _this7.props.table.database;
            _this7.state.tableName = _this7.props.table.table;

            _this7.serverSelected(_this7.state.serverId);
            _this7.databaseSelected(_this7.state.databaseName);
        }
        return _this7;
    }
    ...
    _createClass(TableSelector, [{
        ...
        value: function getServers() {
            ...
            $.get(DOMAIN + '/api/mysql/servers').done(function (data) {
                if (data.success) {
                    _this8.setState({ servers: data.data });
                }
            });
        }
    }, {
        ...
        value: function serverSelected(serverId) {
            ...
            $.get(DOMAIN + '/api/mysql/databases', { serverId: serverId }).done(function (data) {
                if (data.success) {
                    _this9.setState({ databases: data.data, serverId: serverId });
                }
            });
        }
    }, {
        ...
        value: function databaseSelected(databaseName) {
            ...
            $.get(DOMAIN + '/api/mysql/tables', { serverId: this.state.serverId, database: databaseName }).done(function (data) {
                if (data.success) {
                    _this10.setState({ tables: data.data, databaseName: databaseName });
                }
            });
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this11.serverSelected(option.id);
                    } }),
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this11.databaseSelected(option.value);
                    } }),
                _react2.default.createElement(_select2.default, { className: 'mt-3 fullWidth',
                    ...
                    onItemClick: function onItemClick(option) {
                        _this11.setState({ tableName: option.value });
                        if (_this11.props.onSelected !== undefined) {
                            _this11.props.onSelected({
                                serverId: _this11.state.serverId,
                                databaseName: _this11.state.databaseName,
