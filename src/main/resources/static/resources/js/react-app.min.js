    ...
    _createClass(AbstractClient, [{
        ...
        value: function get(uri, data) {
            ...
            var _error = function error(message) {
                if (message != null) showError(message);else showError("Network error");
            };
...
var MySQLApiClient = function (_AbstractClient) {
    ...
    _createClass(MySQLApiClient, [{
        key: "getFields",
        value: function getFields(tableInfo) {
    ...
    _createClass(TaskCreate, [{
        ...
        value: function tableSelected(o, isSource) {
            ...
            if (this.state.table.source != null && this.state.table.target != null) {
                ...
                this.mysqlApiClient.getFields(params).done(function (data) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(TaskFilter, { filters: this.state.filters, addFilter: function addFilter(filter, cb) {
                            var params = {
                                serverId: _this4.state.table.source.serverId,
                                database: _this4.state.table.source.database,
                                table: _this4.state.table.source.table,
                                filter: filter
                            };

                            $.post(DOMAIN + "/api/mysql/validate-filter", params).done(function (data) {
                                if (data.success) {
