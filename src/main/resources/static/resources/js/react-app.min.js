...
var AbstractClient = function () {
    ...
    _createClass(AbstractClient, [{
        ...
        value: function get(uri, data) {
            ...
            $.get(DOMAIN + uri, data).done(function (data) {
                if (data.success) {
        ...
        value: function post(uri, data) {
            var _done2 = null;
            var _error2 = function error(message) {
                return showError(message);
            };
            $.post(DOMAIN + uri, data).done(function (data) {
                if (data.success) {
                    if (_done2 != null) _done2(data.data);
                } else {
                    _error2(data.errorMessage);
                }
            }).fail(function () {
                _error2("Network failed");
            });
        ...
        value: function postJson(uri, data) {
            var _done3 = null;
            var _error3 = function error(message) {
                return showError(message);
            };
            $.ajax(DOMAIN + uri, {
                ...
                if (data.success) {
                    if (_done3 != null) _done3(data.data);
                } else {
                    _error3(data.errorMessage);
                }
            }).fail(function () {
                _error3("Network failed");
            });
...
var TaskApiClient = function (_AbstractClient) {
    ...
    _createClass(TaskApiClient, [{
        ...
        key: 'getFullMigrationTaskProgress',
        value: function getFullMigrationTaskProgress(taskId) {
...
},{"./table-selector":7,"react":32}],7:[function(require,module,exports){
"use strict";
...
},{"../api-client/mysql-api-client":2,"./select":5,"react":32}],8:[function(require,module,exports){
'use strict';
...
},{"react":32}],9:[function(require,module,exports){
/**
...
},{"./table-structure-sync.js":34,"./task-create.js":35,"./task-detail.js":36}],34:[function(require,module,exports){
"use strict";
...
},{"./api-client/mysql-api-client":2,"./common/editable-text":4,"./common/table":8,"./common/table-selector":7,"./common/table-selector-editable":6,"react":32,"react-dom":29}],35:[function(require,module,exports){
'use strict';
...
},{"./api-client/mysql-api-client":2,"./api-client/task-api-client":3,"./common/table":8,"./common/table-selector":7,"react":32,"react-dom":29}],36:[function(require,module,exports){
'use strict';
...
var TaskDetail = function (_React$Component) {
    ...
    function TaskDetail(props) {
        ...
        _this.state = { fullMigrationProgress: 0 };
        return _this;
    }
    ...
    _createClass(TaskDetail, [{
        ...
        key: 'observeFullMigrationProgress',
        value: function observeFullMigrationProgress() {
            var _this3 = this;

            this.fullMigrationProgressInterval = setInterval(function () {
                return _taskApiClient2.default.getFullMigrationTaskProgress(taskId).done(function (data) {
                    _this3.setState({ fullMigrationProgress: data });
                    if (parseInt(data) === 100) {
                        clearInterval(_this3.fullMigrationProgressInterval);
                    }
                });
            });
        }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'button',
                            { type: 'button', className: 'float-right btn btn-primary btn-sm ml-1' },
                            'Stop'
                        ),
                        _react2.default.createElement(
                            'button',
                            { type: 'button', className: 'float-right btn btn-primary btn-sm',
                                onClick: function onClick() {
                                    return _taskApiClient2.default.startFullMigrationTask(taskId).done(function () {
                                        return _this4.observeFullMigrationProgress();
                                    });
                                } },
                            'Start'
                        )
...
},{"./api-client/task-api-client":3,"react":32,"react-dom":29}]},{},[33]);
