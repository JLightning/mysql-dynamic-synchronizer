    ...
    _createClass(TaskCreate, [{
        ...
        value: function tableSelected(o, isSource) {
            ...
            if (table.source !== undefined && table.target !== undefined) {
                var sourceParam = table.source;
                var targetParam = table.target;
                var postParam = {
...
var TableSelector = function (_React$Component2) {
    _inherits(TableSelector, _React$Component2);

    function TableSelector(props) {
        _classCallCheck(this, TableSelector);

        var _this4 = _possibleConstructorReturn(this, (TableSelector.__proto__ || Object.getPrototypeOf(TableSelector)).call(this, props));

        _this4.state = { servers: [], databases: [], tables: [] };
        return _this4;
    }
    ...
    _createClass(TableSelector, [{
        ...
        value: function getServers() {
            ...
            $.get('/api/mysql/servers').done(function (data) {
                if (data.success) {
                    _this5.setState({ servers: data.data });
                }
            });
        }
    }, {
        ...
        value: function serverSelected(serverId) {
            ...
            $.get('/api/mysql/databases', { serverId: serverId }).done(function (data) {
                if (data.success) {
                    _this6.setState({ databases: data.data, serverId: serverId });
                }
            });
        }
    }, {
        ...
        value: function databaseSelected(databaseName) {
            ...
            $.get('/api/mysql/tables', { serverId: this.state.serverId, database: databaseName }).done(function (data) {
                if (data.success) {
                    _this7.setState({ tables: data.data, databaseName: databaseName });
                }
            });
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_select2.default, {
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this8.serverSelected(option.id);
                    } }),
                _react2.default.createElement(
                    'p',
                    { className: 'mt-3' },
                ...
                _react2.default.createElement(_select2.default, {
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this8.databaseSelected(option.value);
                    } }),
                _react2.default.createElement(
                    'p',
                    { className: 'mt-3' },
                ...
                _react2.default.createElement(_select2.default, {
                    ...
                    btnTitle: 'Select Database',
                    onItemClick: function onItemClick(option) {
                        _this8.setState({ tableName: option.value });
                        if (_this8.props.onSelected !== undefined) {
                            _this8.props.onSelected({
                                serverId: _this8.state.serverId,
                                databaseName: _this8.state.databaseName,
