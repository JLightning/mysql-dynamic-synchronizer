...
var TaskCreate = function (_React$Component) {
    ...
    function TaskCreate() {
        ...
        return _possibleConstructorReturn(this, (TaskCreate.__proto__ || Object.getPrototypeOf(TaskCreate)).apply(this, arguments));
    }
...
var TableSelector = function (_React$Component2) {
    ...
    function TableSelector(props) {
        ...
        var _this2 = _possibleConstructorReturn(this, (TableSelector.__proto__ || Object.getPrototypeOf(TableSelector)).call(this, props));

        _this2.state = { servers: [], databases: [], tables: [] };
        return _this2;
    }
    ...
    _createClass(TableSelector, [{
        ...
        value: function getServers() {
            ...
            $.get('/api/mysql/servers').done(function (data) {
                if (data.success) {
                    _this3.setState({ servers: data.data });
                }
            });
        }
    }, {
        key: 'getDatabases',
        value: function getDatabases(option) {
            var _this4 = this;

            $.get('/api/mysql/databases?serverId=' + option.id).done(function (data) {
                if (data.success) {
                    _this4.setState({ databases: data.data, serverId: option.id });
                }
            });
        }
    }, {
        key: 'getTables',
        value: function getTables(option) {
            var _this5 = this;

            $.get('/api/mysql/tables?serverId=' + this.state.serverId + "&database=" + option.value).done(function (data) {
                if (data.success) {
                    _this5.setState({ tables: data.data, databaseName: option.value });
                }
            });
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_select2.default, {
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this6.getDatabases(option);
                    } }),
                _react2.default.createElement(
                    'p',
                    { className: 'mt-3' },
                ...
                _react2.default.createElement(_select2.default, {
                    ...
                    onItemClick: function onItemClick(option) {
                        return _this6.getTables(option);
                    } }),
                _react2.default.createElement(
                    'p',
                    { className: 'mt-3' },
                ...
                _react2.default.createElement(_select2.default, {
                    ...
                    btnTitle: 'Select Database',
                    onItemClick: function onItemClick(option) {
                        return _this6.setState({ tableName: option.value });
                    } })
            );
        }
    }]);
