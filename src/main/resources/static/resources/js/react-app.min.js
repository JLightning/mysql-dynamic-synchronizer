...
var MySQLApiClient = function (_AbstractClient) {
    ...
    _createClass(MySQLApiClient, [{
        ...
        key: 'getDatabases',
        value: function getDatabases(serverId) {
            return this.get('/api/mysql/databases', { serverId: serverId });
        }
    }, {
        key: 'getTables',
        value: function getTables(serverId, database) {
            return this.get('/api/mysql/tables', { serverId: serverId, database: database });
        }
    }, {
        key: 'getFields',
        value: function getFields(serverId, database, table) {
            return this.get('/api/mysql/fields', { serverId: serverId, database: database, table: table });
        }
    }, {
        key: 'getMapping',
        value: function getMapping(sourceServerId, sourceDatabase, sourceTable, targetServerId, targetDatabase, targetTable, mapping) {
...
var TableSelector = function (_React$Component) {
    ...
    _createClass(TableSelector, [{
        ...
        value: function serverSelected(serverId) {
            ...
            _mysqlApiClient2.default.getDatabases(serverId).done(function (data) {
        ...
        value: function databaseSelected(databaseName) {
            ...
            _mysqlApiClient2.default.getTables(this.state.serverId, databaseName).done(function (data) {
...
},{"../api-client/mysql-api-client":2,"./select":3,"react":28}],5:[function(require,module,exports){
/**
...
},{"./table-structure-sync.js":30,"./task-create.js":31,"./task-detail.js":32}],30:[function(require,module,exports){
"use strict";
...
},{"./common/table-selector":4,"react":28,"react-dom":25}],31:[function(require,module,exports){
'use strict';
    ...
    _createClass(TaskCreate, [{
        ...
        value: function tableSelected(o, isSource) {
            ...
            if (this.state.table.source != null && this.state.table.target != null) {
                ...
                _mysqlApiClient2.default.getFields(o.serverId, o.databaseName, o.tableName).done(function (data) {
        ...
        value: function getMapping() {
            ...
            _mysqlApiClient2.default.getMapping(sourceParam.serverId, sourceParam.database, sourceParam.table, targetParam.serverId, targetParam.database, targetParam.table, mapping).done(function (data) {
...
},{"./api-client/mysql-api-client":2,"./common/table-selector":4,"react":28,"react-dom":25}],32:[function(require,module,exports){
'use strict';
...
var TaskDetail = function (_React$Component) {
    ...
    _createClass(TaskDetail, [{
        ...
        value: function componentDidMount() {
            ...
            $.get(DOMAIN + '/api/task/detail/' + taskId).done(function (data) {
                if (data.success) {
                    _this2.setState({ task: data.data });
                }
            });
        ...
        value: function observeFullMigrationProgress() {
            ...
            this.fullMigrationProgressInterval = setInterval(function () {
                return $.get(DOMAIN + '/api/task/detail/' + taskId + '/full-migration-progress').done(function (data) {
                    if (data.success) {
                        _this3.setState({ fullMigrationProgress: data.data });
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'button',
                            { type: 'button', className: 'float-right btn btn-primary btn-sm', onClick: function onClick() {
                                    $.get(DOMAIN + '/api/task/detail/' + taskId + '/start-full-migration').done(function (data) {
                                        if (data.success) {
                                            _this4.observeFullMigrationProgress();
                                        } else {
                                            showError(data.errorMessage);
                                        }
                                    });
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { type: 'button', className: 'float-right btn btn-primary btn-sm ml-1', onClick: function onClick() {
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { type: 'button', className: 'float-right btn btn-primary btn-sm', onClick: function onClick() {
                                            $.get(DOMAIN + '/api/task/detail/' + taskId + '/start-incremental-migration').done(function (data) {
                                                if (!data.success) {
                                                    showError(data.errorMessage);
                                                }
                                            });
