...
var TaskCreate = function (_React$Component) {
    ...
    function TaskCreate(props) {
        ...
        _this.mysqlApiClient = new _mysqlApiClient2.default();
    ...
    _createClass(TaskCreate, [{
        ...
        value: function tableSelected(o, isSource) {
            ...
            if (this.state.table.source != null && this.state.table.target != null) {
                ...
                this.mysqlApiClient.getFields(o.serverId, o.databaseName, o.tableName).done(function (data) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(TaskFilter, { filters: this.state.filters, addFilter: function addFilter(filter, cb) {
                            _this4.mysqlApiClient.validateFilter(state.table.source.serverId, state.table.source.database, state.table.source.table, filter).done(function (data) {
