...
var TaskApiClient = function (_AbstractClient) {
    ...
    _createClass(TaskApiClient, [{
        ...
        value: function createTaskActionFlat(taskId, taskName, mapping, source, target, taskType, insertMode) {
            return this.postJson('/api/task/create', { taskId: taskId, taskName: taskName, mapping: mapping, source: source, target: target, taskType: taskType, insertMode: insertMode });
        }
    }, {
...
var ToolApiClient = function (_AbstractClient) {
    ...
    _createClass(ToolApiClient, [{
        ...
        value: function syncStructureFlat(taskId, taskName, mapping, source, target, taskType, insertMode) {
            return this.postJson('/api/tool/sync-structure', { taskId: taskId, taskName: taskName, mapping: mapping, source: source, target: target, taskType: taskType, insertMode: insertMode });
        }
    }, {
        key: 'syncStructure',
